...
public class AddPersAccDialog extends javax.swing.JDialog
{
    /**
	 * 
	 */
	...
	public AddPersAccDialog(BankFrame parent, String title, ICustomer customer)
	{
		super(parent);
		parentframe=parent;
		 newAccount = true;
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
       ...
       parentframe.okAddAccountClicked = true;
       if(newAccount)
    ...
    //make this frame invisible if Cancel button is clicked
		parentframe.okAddAccountClicked = false;
        dispose();
	}
}